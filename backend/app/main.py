...
app=FastAPI(title="FitAI Local AI Runtime",version="0.3.0")
...
def health():
    return {"status":"ok","backend":"mediapipe-opencv-cpu","version":"0.3.0","capabilities":{"pose":True,"segmentation":True,"face_detection":True}}
