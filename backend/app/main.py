...
app=FastAPI(title="FitAI Local AI Runtime",version="0.4.0")
...
def health():
    return {"status":"ok","backend":"mediapipe-opencv-cpu","version":"0.4.0","capabilities":{"pose":True,"segmentation":True,"face_detection":True,"face_mesh":True,"hair_semantic_segmentation":False,"pose_aware_ar_garment":True}}
